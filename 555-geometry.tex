...
\begin{enumerate}
    ...
    \item Seja $ABCD$ um quadrilátero circunscrito. Prove que o incentro $I$ e os pontos médios $M$ e $N$ dos segmentos $AC$ e $BD$, respectivamente, são colineares. \dica %Contas com áreas
    
    \item Seja $ABCD$ um quadrilátero circunscrito de incírculo $k$. As circunferências $k_1(I_1)$, $k_2(I_2)$, $k_3(I_3)$, $k_4(I_4)$ são os incírculos de $\Delta ARU$, $\Delta RBS$, $\Delta SCT$ e $\Delta UTD$, respectivamente, onde $R$, $S$, $T$ e $U$ são os pontos de tangência de $AB$, $BC$, $CD$ e $DA$ com $k$, respectivamente. Denote as retas tangentes externas em comum entre $k_1$ e $k_2$, de $k_2$ e $k_3$, de $k_3$ e $k_4$, e de $k_4$ e $k_1$, distintas dos lados de $ABCD$, por $t_{12}$, $t_{23}$, $t_{34}$ e $t_{14}$, respectivamente. Sejam $M=t_{12}\cap t_{14}$, $N=t_{12}\cap t_{23}$, $P=t_{23}\cap t_{34}$ e $Q=t_{34}\cap t_{14}$. Prove que o quadrilátero $MNPQ$ é um losango. \dica %Angle chasing %Use os problemas anteriores
    
    \item Seja $ABCD$ um quadrilátero circunscrito de incírculo $k$. A circunferência $k_1$ é inscrita em $\angle ABC$ e intersecta o segmento $AC$ nos pontos $M$ e $N$. Prove que a circunferência que passa por $M$ e $N$, e que toca $CD$, também toca $AD$. \dica %Eixo radical
    
    \item Seja $ABCD$ um quadrilátero circunscrito de incírculo $k$. Seja $AC\cap BD=X$. Sejam $k_1(M)$, $k_2(N)$, $k_3(P)$ e $k_4(Q)$ os incírculos de $\Delta ABX$, $\Delta BCX$, $\Delta CDX$ e $\Delta DAX$, respectivamente. Prove que o quadrilátero $MNPQ$ é cíclico. \dica %Teorema de Brianchon %Contas com trigonometria
    
    \item Seja $ABCD$ um quadrilátero circunscrito de incírculo $k$ de centro $I$. Os pés das perpendiculares de $B$ e $D$ até a bissetriz interna de $\angle BAD$ são $M$ e $P$, respectivamente, e os pés das perpendiculares de $B$ e $D$ até a bissetriz interna de $\angle BCD$ são $N$ e $Q$, respectivamente. Prove que o quadrilátero $MNPQ$ é cíclico. \dica %Angle chasing
    
    \item Seja $ABCD$ um quadrilátero circunscrito de incírculo $k$ de centro $I$. Seja $ABCD$ também inscrito numa circunferência $k_1$. Os pontos $T$ e $J$ são os incentros de $\Delta ABC$ e $\Delta ADC$, respectivamente. Prove que o quadrilátero $DJTB$ é cíclico. \dica %Marcação de ângulos e segmentos
    
    \item Seja $ABCD$ um quadrilátero circunscrito de incírculo $k$ de centro $I$. Seja $ABCD$ também inscrito numa circunferência $k_1$. Digamos que $k$ toque $AB$, $BC$, $CD$ e $DA$ nos pontos $M$, $N$, $P$ e $Q$, respectivamente. Prove que $MP\perp NQ$. \dica %Angle chasing
    
    \item Seja $ABCD$ um quadrilátero circunscrito de incírculo $k$ de centro $I$. A reta $AC$ intersecta $k$ em $Y$ e $Z$. O ponto $X$ é o ponto médio de $YZ$. Prove que $\angle BXC=\angle DXC$. \dica %Projetiva %Ponto fantasma %Reta polar %Teorema de Brianchon %Teorema de Menelaus %Teorema de Ceva
    
    \item Seja $ABCD$ um quadrilátero circunscrito de incírculo $k$ de centro $I$. A reta que passa por $A$ e que é perpendicular a $AD$, intersecta a bissetriz interna de $\angle ADC$ no ponto $T$, e a reta que passa por $A$ e que é perpendicular a $AB$, intersecta a bissetriz interna de $\angle ABC$ no ponto $S$. Prove que $ST\perp AC$. \dica %Reta polar e polo %Teorema de Brianchon
    
    \item Seja $k$ uma circunferência inscrita no ângulo $\angle ABC$. Digamos que $k$ toque $AB$ e $BC$ nos pontos $M$ e $P$, respectivamente. Uma reta que passa por $B$ intersecta $k$ nos pontos $N$ e $Q$, de forma que $N$ fica entre $B$ e $Q$. O ponto $X$ é o ponto médio do segmento $NQ$. Prove que $\angle MXN=\angle PXN$. \dica %Reta polar %Simediana %Angle chasing
    
    \item Seja $ABCD$ um quadrilátero circunscrito com $BC\cap AD=F$ e $BA\cap CD=E$. Sejam $N\in BC$ e $M\in AB$. A reta $FM$ intersecta as retas $EN$ e $DC$ nos pontos $X$ e $P$, respectivamente. Seja $EX\cap AD=Q$. Se o quadrilátero $AMXQ$ é circunscritível, prove que o quadrilátero $XNCP$ é circunscritível. \dica %Teorema de Bico
    
    \item Seja $ABCD$ um quadrilátero circunscrito de incírculo $k$. Sejam $AD\cap BC=E$ e $AB\cap CD=F$. As circunferências $k_1$, $k_2$ e $k_3$ são inscritas em $\angle ABC$, $\angle BCD$ e $\angle CDA$, respectivamente. Uma das retas tangentes internas em comum entre $k_1$ e $k_2$ passa por $F$ e intersecta $EA$ e as retas tangentes de $E$ até $k_1$ e $k_3$ nos pontos $M$, $S$ e $R$, respectivamente. A reta tangente a $k_3$ e que passa por $F$ intersecta as mesmas retas nos pontos $N$, $P$ e $Q$, respectivamente. Uma das retas tangentes internas em comum entre $k_2$ e $k_3$ passa por $E$ e intersecta $DC$ e $AB$ nos pontos $K$ e $H$. A reta tangente a $k_1$ que passa por $E$ intersecta $DC$ e $AB$ nos pontos $L$ e $G$, respectivamente. Prove que o quadrilátero $AGPN$ é circunscritível. \dica %Use os problemas anteriores
    
    \item Seja $ABCD$ um quadrilátero convexo. As bissetrizes $l_a$, $l_b$, $l_c$ e $l_d$ dos ângulos externos de $ABCD$ formam o quadrilátero $EFGH$, onde $l_a\cap l_b=E$, $l_b\cap l_c=F$, $l_c\cap l_d=G$ e $l_d\cap l_a=H$. A perpendicular de $E$ até $AB$ intersecta a perpendicular de $F$ até $BC$ no ponto $N$. A perpendicular de $G$ até $CD$ intersecta a perpendicular de $F$ até $BC$ no ponto $M$. A perpendicular de $E$ até $AB$ intersecta a perpendicular de $H$ até $AD$ no ponto $K$. A perpendicular de $H$ até $AD$ intersecta a perpendicular de $G$ até $DC$ no ponto $L$. Prove que o quadrilátero $LMNK$ é circunscritível. \dica %Angle chasing    
