...
\begin{enumerate}
    ...
    \item Seja $ABC$ um triângulo. Prove que suas medianas $CD$, $AE$ e $BF$ são concorrentes.
    
    \item Seja $ABC$ um triângulo. Prove que suas alturas $AE$, $CF$ e $BD$ são concorrentes.
    
    \item Prove que as bissetrizes internas de um $\triangle ABC$ são concorrentes.
